...
const generatePalette = require(path.resolve(__dirname, ('libs/fuse/src/lib/tailwind/utils/generate-palette')));
...
const config = {
    ...
    plugins     : [
        ...
        require(path.resolve(__dirname, ('libs/fuse/src/lib/tailwind/plugins/extract-config'))),
        require(path.resolve(__dirname, ('libs/fuse/src/lib/tailwind/plugins/utilities'))),
        require(path.resolve(__dirname, ('libs/fuse/src/lib/tailwind/plugins/icon-size'))),
        require(path.resolve(__dirname, ('libs/fuse/src/lib/tailwind/plugins/theming')))({themes}),
