...
const routes: Routes = [
  {
    path: '',
    loadChildren: () =>
      import('../feature-users/feature-users.module').then((m) => m.FeatureUsersModule),
    data: {
  ...
  },
  {
    ...
    loadChildren: () =>
      import('../feature-users-details/feature-users-details.module').then(
        (m) => m.FeatureUsersDetailsModule
      ),
    data: {
